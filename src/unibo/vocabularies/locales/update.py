...
domain = 'unibo.vocabularies'
os.chdir(pkg_resources.resource_filename(domain, ''))
os.chdir('../../../')
target_path = 'src/unibo/vocabularies/'
...
def locale_folder_setup():
    ...
    for lang in languages:
        ...
        if 'LC_MESSAGES' in folder:
            ...
            cmd = 'msginit --locale={0} --input={1}.pot --output={2}/LC_MESSAGES/{3}.po'.format(lang, domain, lang, domain)  # NOQA
            subprocess.call(
                cmd,
                shell=True,
            )
